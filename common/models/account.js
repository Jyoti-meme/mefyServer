...
module.exports = function (account) {
  ...
  account.addBankAccount = function (data, cb) {
    if (data != null && Object.keys(data).length != 0) {
      if (data.doctorId) {
        account.create({ doctorId: data.doctorId, accountHolderName: data.accountHolderName, ifscCode: data.ifscCode, accountName: data.accountName, accountType: data.accountType }, function (err, account) {
        ...
        account.create({ individualId: data.individualId, accountHolderName: data.accountHolderName, ifscCode: data.ifscCode, accountName: data.accountName, accountType: data.accountType }, function (err, account) {
